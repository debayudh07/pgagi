    ...
    <div className="space-y-6 p-4 md:p-6 pb-32">
        ...
        <div className="flex flex-col md:flex-row md:items-center gap-4">
          ...
          <div>
            ...
            <p className="text-orange-500 font-bold mt-1">
              {safeTopArtistsWithTracks.length} top artists • {safeMusic.length} hot tracks 🎧
            </p>
          </div>
        </div>
        <Button
          ...
          className="gap-2 border-2 border-green-500 text-green-500 hover:bg-green-500 hover:text-white font-bold transition-all duration-300 transform hover:scale-105"
        >
      ...
      <div className="flex flex-wrap gap-2 items-center">
        <Button
          ...
          className="gap-2 border-2 border-purple-500 text-purple-500 hover:bg-purple-500 hover:text-white font-bold transition-all duration-300"
        >
        ...
        {showGenreFilter && (
          ...
          >
            <Button
              ...
              className="text-xs font-bold border border-gray-400"
            >
              All
            </Button>
            {safeAvailableGenres.slice(0, 10).map((genre) => (
              <Button
                key={genre}
                variant={selectedGenre === genre ? "default" : "outline"}
                onClick={() => handleGenreSelect(genre)}
                className="text-xs font-bold border border-purple-400"
              >
                {genre}
              </Button>
            ))}
        ...
        <CardContent>
          {isSpotifyConnected ? (
            <div className="space-y-6">
              ...
              <div className="flex items-center justify-between p-4 bg-green-500/10 border border-green-500 rounded-lg">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h3 className={`font-bold ${theme.isDark ? 'text-white' : 'text-gray-900'}`}>
              ...
              {contentState.userTopTracks && contentState.userTopTracks.length > 0 && (
                <div>
                  <h4 className={`text-lg font-bold mb-4 ${theme.isDark ? 'text-white' : 'text-gray-900'}`}>
                    🎵 Your Top Tracks
                  </h4>
                      ...
                      >
                        <div className="flex items-center gap-3">
                          ...
                          <div className="flex-1 min-w-0">
                            <h5 className={`font-bold text-sm truncate ${theme.isDark ? 'text-white' : 'text-gray-900'}`}>
                              {track.title}
                            </h5>
            ...
            <div className="text-center py-8">
              <div className="mb-6">
                <div className="w-20 h-20 mx-auto mb-4 bg-green-500/20 rounded-full flex items-center justify-center border-2 border-green-500">
              ...
              <div className="space-y-4">
                <Button
                  className="bg-green-500 hover:bg-green-600 text-white font-bold py-3 px-8 rounded-full transform hover:scale-105 transition-all duration-300 shadow-lg"
                  onClick={() => {
        ...
        >
          ...
          {safeTopArtistsWithTracks.map((artistData, index) => (
            <Card
              ...
              className={`backdrop-blur-xl border-2 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-[1.02] ${
                theme.isDark
              ...
              <CardHeader className="pb-4">
                <div className="flex items-center gap-4">
                  ...
                  <div className="flex-1">
                    <CardTitle className={`text-xl font-black transition-colors duration-300 ${
                      theme.isDark ? 'text-white' : 'text-gray-900'
                    }`}>
                    ...
                    <div className="flex items-center gap-4 mt-2">
                      ...
                      <Badge className="bg-purple-500/80 text-white font-bold">
                    ...
                    >
                      <div className="flex items-center gap-3">
                        ...
                        <img
                          ...
                          alt={track.title}
                          className="w-10 h-10 rounded object-cover border border-green-500/30"
                        />
                        <div className="flex-1 min-w-0">
                          <h5 className={`font-bold text-sm truncate transition-colors duration-300 ${
                            theme.isDark ? 'text-white' : 'text-gray-900'
                          }`}>
                            {track.title}
                          </h5>
      ...
      {safeMusic.length > 0 && (
        <motion.div
          ...
          className={`backdrop-blur-md border rounded-lg p-4 md:p-6 transition-colors duration-300 ${
            theme.isDark
        ...
        >
          <div className="flex items-center gap-2 md:gap-3 mb-4 md:mb-6">
            ...
            <Badge className="bg-green-500/80 text-white border-green-400 font-bold">{safeMusic.length}</Badge>
          </div>
          <ContentGrid
            items={safeMusic}
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        <Card className={`backdrop-blur-xl border-2 shadow-lg shadow-green-500/20 hover:shadow-green-500/40 transition-all duration-300 transform hover:scale-105 ${
          ...
          <CardContent className="p-4 text-center">
            ...
            <p className="font-black text-lg text-green-400">Charts</p>
        ...
        <Card className={`backdrop-blur-xl border-2 shadow-lg shadow-purple-500/20 hover:shadow-purple-500/40 transition-all duration-300 transform hover:scale-105 ${
          ...
          <CardContent className="p-4 text-center">
            <div className="text-2xl mb-2">✨</div>
            <p className="font-black text-lg text-purple-400">New</p>
            <p className={`text-xs font-bold transition-colors duration-300 ${
              theme.isDark ? 'text-white' : 'text-gray-700'
            }`}>Releases</p>
          </CardContent>
        ...
        <Card className={`backdrop-blur-xl border-2 shadow-lg shadow-blue-500/20 hover:shadow-blue-500/40 transition-all duration-300 transform hover:scale-105 ${
          ...
          <CardContent className="p-4 text-center">
            <div className="text-2xl mb-2">🔥</div>
            <p className="font-black text-lg text-blue-400">Trending</p>
            <p className={`text-xs font-bold transition-colors duration-300 ${
              theme.isDark ? 'text-white' : 'text-gray-700'
            }`}>Viral Sounds</p>
          </CardContent>
        ...
        <Card className={`backdrop-blur-xl border-2 shadow-lg shadow-orange-500/20 hover:shadow-orange-500/40 transition-all duration-300 transform hover:scale-105 ${
          ...
          <CardContent className="p-4 text-center">
            <div className="text-2xl mb-2">🎧</div>
            <p className="font-black text-lg text-orange-400">Artists</p>
            <p className={`text-xs font-bold transition-colors duration-300 ${
              theme.isDark ? 'text-white' : 'text-gray-700'
            }`}>{safeTopArtistsWithTracks.length} Featured</p>
          </CardContent>
        </Card>
      </div>
